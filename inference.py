...
def inference(model, data, device, num_im, row, class_name = None, im_dim = None, save_inference_images  = None, data_name =None ):
...
# model.eval()
# inference(model = model.eval(), data = ts_dl, device = device ,num_im = 20, row =4, class_name = list(classes.keys()), im_dim = 224)